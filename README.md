...
Holochain hApp for ephemeral messaging.
...
You'll have the `zipzap.webhapp` in `workdir`. This is what you should distribute so that the Holochain Launcher can install it.
You will also have its subcomponent `zipzap.happ` in the same folder`.
