...
pub fn validate(op: Op) -> ExternResult<ValidateCallbackResult> {
    match op.flattened::<EntryTypes, LinkTypes>()? {
        ...
        FlatOp::RegisterCreateLink {
            ...
            match link_type {
                LinkTypes::ThingUpdates => {
                    validate_create_link_thing_updates(
                        action,
                        base_address,
                        target_address,
                        tag,
                ...
                LinkTypes::AllThings => {
                    validate_create_link_all_things(
                        action,
                        base_address,
                        target_address,
                        tag,
        ...
        FlatOp::RegisterDeleteLink {
            ...
            match link_type {
                LinkTypes::ThingUpdates => {
                    validate_delete_link_thing_updates(
                        action,
                        original_action,
                        base_address,
                        target_address,
                ...
                LinkTypes::AllThings => {
                    validate_delete_link_all_things(
                        action,
                        original_action,
                        base_address,
                        target_address,
